function FeedbackMaterial(RENDERER, SCENE, CAMERA, TEXTURE, SHADERS){
    ...
    this.init = function(){
        ...
        // this.fbo2.material.uniforms.noiseTex.value = THREE.ImageUtils.loadTexture("../tex/rgb-noise.png");
        ...
        for(var i = 0; i < this.fbos.length; i++){
          ...
          // this.fbos[i].material.uniforms["noiseTex"].value = THREE.ImageUtils.loadTexture("../tex/rgb-noise.png");
        ...
        this.material.uniforms["noiseTex"].value = THREE.ImageUtils.loadTexture("../tex/rgb-noise.png");
        ...
        // this.geometry = new THREE.PlaneGeometry(1920/1.5,1080/1.5, 0);
    ...
    this.update = function(){
        ...
        this.outputShader.uniforms["time"].value = time;
    }
